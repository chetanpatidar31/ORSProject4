...
<body>
 ...
 %>             	<a
					...
					href="<%=ORSView.MARKSHEET_MERIT_LIST_CTL%>">Marksheet Merit List</b></a> | <a
					...
					href="<%=ORSView.PHYSICIAN_CTL%>">Add Physician</a> | <%-- <a
					href="<%=ORSView.PHYSICIAN_LIST_CTL%>">Physician List</a> |--%>  <a
