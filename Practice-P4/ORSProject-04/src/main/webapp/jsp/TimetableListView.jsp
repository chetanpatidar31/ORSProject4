        ...
        <form action="<%=ORSView.TIMETABLE_LIST_CTL%>" method="post">
            ...
            <table style="width: 100%">
                <tr>
                    <td align="right">
                        ...
                        <%=HTMLUtility.getList("subjectId", String.valueOf(bean.getSubjectId()), subjectList)%>&emsp;
                    ...
                    <td align="left">
                        <label class="input-group">
                            ...
                            <span data-datepicker date-format="MM/dd/yyyy" date-typer="true">
                                <input type="text" name="examDate" placeholder="Select Date of Exam" readonly="readonly"
            ...
            <table border="1" style="width: 100%; border: groove;">
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <a href="TimetableCtl?id=<%=bean.getId()%>">Edit</a>
                    </td>
                </tr>
                <%
                    }
